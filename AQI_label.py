# -*- coding: utf-8 -*-
"""
Created on Thu Jan  7 14:08:32 2021
...
for month_num in range(1,13):
    ...
    AQI_result = np.zeros(shape=[6, days])
    ...
    for day_num in range(days):
        ...
        data_temp_result = np.array([mean_wind_direct, mean_temper, mean_rain, mean_humidity, mean_wind_speed, temp_AQI])
        AQI_result[:, day_num] = data_temp_result.T
        new_frame.iloc[0, 2:8] = data_temp_result
...
result_all.to_csv('./time_train/train_all.csv', index = False)

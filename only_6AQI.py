# -*- coding: utf-8 -*-
"""
Created on Sun Jan 10 11:51:33 2021
...
for month_num in range(1,13):
    ...
    for day_num in range(days):
        ...
        # print(temp_AQI)
        data_temp_result = np.array([AQI_CO, AQI_PM10, AQI_PM25, AQI_SO2, temp_AQI])
        AQI_result[:, day_num] = data_temp_result
...
result_all.to_csv('./time_train/train_only6AQI_3.csv', index = False)
